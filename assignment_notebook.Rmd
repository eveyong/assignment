...
The MSE for the models are summarised below:
...
The diagram below shows real versus predicted for different machine learning algorithms.

```{r}

```

Neural Network model did the best job in predicitng average house prices in London. Multiple Linear Regression and Decision Tree was not as good at predicting the average house prices.  
